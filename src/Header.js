...
function Header() {
const [{ basket ,user} , dispatch] = useStateValue(); //basketachn lemawured lemamtat snfelg (basket) entekemaln lemelak dem (dispatch)
        ...
        <div className="header_option">
          ...
          <span className="header_optionLineTwo">Prime</span>
              ...
              {basket.length}
                    ...
                    {/* <span className='header__optionLineOne'>{basket.lengeth}</span>  */}
